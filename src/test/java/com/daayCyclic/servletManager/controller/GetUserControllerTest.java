    ...
    void getUsersEmptyRolesList() {
        assertDoesNotThrow(() -> {
                mockMvc.perform(get("/users").param("roles", ""))
                    ...
                    .andExpect(MockMvcResultMatchers.jsonPath("$[2].userId").value("3"))
                    ...
                    .andExpect(MockMvcResultMatchers.jsonPath("$[3].userId").value("4"))
                    ...
                    .andExpect(MockMvcResultMatchers.jsonPath("$[4].userId").value("5"))
